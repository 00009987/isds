...
a <- getSymbols("GOOG", src = "yahoo", from="2011-01-01", to = "2021-02-01", auto.assign = T)
a
# ------------------------
...
ggplot(cars, aes(x=speed, y=dist)) +
  ...
  geom_smooth(method = "lm", col = "red", linetype = 5, size = -1.5)+
  labs(title = "Stop Dist Rel to speed",
       x="Speed",
       y="Dist")+
